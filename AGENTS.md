...
- Current phase: M2.2 live local accounts/permissions/recovery slice. Six administration screens use real data, including local encrypted backup/isolated restore checks; remaining workspace/settings/usage screens are samples. Live restore and scheduled/offsite backup are not implemented. Read STATE.md for exact boundaries.
