...
| F1 Identity/security | Account/profile/password administration, provider-operation fencing/reconciliation, login throttling, two-device and third-device approval, seven-day idle reapproval, expiry/reminders; real bypass/role/concurrency probes on isolated fixtures | IN PROGRESS — session admission, throttles and two-device/third-device approval now covered; password/admin, idle, expiry and recovery reconciliation remain open |
