...
| F1 Identity/security | Account/profile/password administration, provider-operation fencing/reconciliation, login throttling, two-device and third-device approval, seven-day idle reapproval, expiry/reminders; real bypass/role/concurrency probes on isolated fixtures | IN PROGRESS — password authority/fencing, session admission, throttles, two-device/third-device approval and seven-day idle reapproval now covered; profile editing, expiry reminders and recovery reconciliation remain open |
