...
Continue real account management, permissions, lock/expiry/recovery and device-session enforcement before live business entry. Ask only unresolved essentials one at a time; base currency is confirmed as MMK (D120). Company timezone is confirmed as Asia/Yangon (D121). Backup destinations are Owner Gmail Google Drive and a dedicated Telegram private Backup Channel with Owner and approved Admins (D122-D123). Daily backup frequency within free-plan usage is confirmed (D124). Execution time is confirmed as 18:00 Asia/Yangon daily (D125). Encryption, retention, missed-run handling, restore authority and integration configuration remain open. No channel creation, connection or external transfer has occurred.
