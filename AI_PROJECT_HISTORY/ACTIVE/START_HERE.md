...
D141: use new Google identities for backup integration and new Supabase/GitHub/Vercel identities/resources for future Production. The selected backup Google account is erp.evershine@gmail.com; Google sign-in and destination verification are pending. See docs/OFFSITE-BACKUP-SETUP.md. Do not use old connected accounts by default.
